        ...
        if not Temple.query.first():
            temples = [
                ...
                Temple(name='Pavagadh Temple', location='Pavagadh, Gujarat', latitude=22.4833, longitude=73.5333,
                      capacity=120, description='Kalika Mata temple')
            ]
            ...
            ambaji = Temple.query.filter_by(name='Ambaji Temple').first()
            if ambaji and not ambaji.image_url:
                ambaji.image_url = 'https://rajmandirhotel.com/wp-content/uploads/2024/02/Ambaji-Temple.webp'
                db.session.commit()
